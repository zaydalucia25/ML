			...
			<div class="nav-menu">
				<ul class="nav-menu-list">
					...
					<li class="nav-menu-item">
						<nav class="nav-categs nav-categs--with-details" hidden="hidden">
							...
							<section class="nav-categs-departments">
								...
								<ul class="nav-categs-departments__list nav-categs-departments__list--static">
									...
									<li><a href="#">Herramientas e Industría</a></li>
								...
								<div class="nav-categs-detail__body">
									<div class="nav-categs-detail__body-content">
										...
										<article class="nav-categs-detail__categ">
											...
											<ul class="nav-categs-detail__categ-list">
												<li><a href="#">Accesorios para Cámaras</a></li>
										...
										<article class="nav-categs-detail__categ">
											...
											<ul class="nav-categs-detail__categ-list">
												...
												<li><a href="#">Equipos de DJ y Accesorios</a></li>
												<li><a href="#">Televisores</a></li>
												<li><a href="#">Reproductores Portátiles</a></li>
											</ul>
										</article>
										<article class="nav-categs-detail__categ">
											<h2 class="nav-categs-detail__title">
							...
							<section class="nav-categs-detail" hidden="hidden">
								<header class="nav-categs-detail__header"><h1>Hogar y Electrodomésticos</h1></header>
								<div class="nav-categs-detail__body">
									<div class="nav-categs-detail__body-content">
										<article class="nav-categs-detail__categ">
											<h2 class="nav-categs-detail__title">
											...
											<ul class="nav-categs-detail__categ-list">
												<li><a href="#">Adornos y decoración del Hogar</a></li>
												<li><a href="#">Cocina</a></li>
												<li><a href="#">Jardines y Exteriores</a></li>
												<li><a href="#">Iluminación para el Hogar</a></li>
											</ul>
										</article>
										<article class="nav-categs-detail__categ">
											<h2 class="nav-categs-detail__title">
										...
										<article class="nav-categs-detail__categ">
											...
											<ul class="nav-categs-detail__categ-list">
												<li><a href="#">Lavabos para Baño</a></li>
												<li><a href="#">Innodoros</a></li>
							...
							<section class="nav-categs-detail" hidden="hidden">
								<header class="nav-categs-detail__header"><h1>Juguetes y Bebés</h1></header>
								<div class="nav-categs-detail__body">
									<div class="nav-categs-detail__body-content">
										<article class="nav-categs-detail__categ">
											<h2 class="nav-categs-detail__title">
												<a href="#">Muñecos y Muñecas</a>
											</h2>
											<ul class="nav-categs-detail__categ-list">
										...
										<article class="nav-categs-detail__categ">
											...
											<ul class="nav-categs-detail__categ-list">
												<li><a href="#">Montables a Batería</a></li>
										...
										<article class="nav-categs-detail__categ">
											...
											<ul class="nav-categs-detail__categ-list">
												...
												<li><a href="#">Automodelismo</a></li>
											</ul>
										</article>
										<article class="nav-categs-detail__categ">
											<h2 class="nav-categs-detail__title">
												<a href="#">Recámara de Bebés</a>
											</h2>
											<ul class="nav-categs-detail__categ-list">
												<li><a href="#">Cunas y Moisés</a></li>
												<li><a href="#">Ropa y Protectores para Cuna</a></li>
											</ul>
										</article>
										<article class="nav-categs-detail__categ">
											<h2 class="nav-categs-detail__title">
												<a href="#">Juegos y Juguetes para Bebés</a>
											</h2>
											<ul class="nav-categs-detail__categ-list">
												<li><a href="#">Mecedoras y Columpios</a></li>
												<li><a href="#">Gimnasios</a></li>
											</ul>
										</article>
										<article class="nav-categs-detail__categ">
											<h2 class="nav-categs-detail__title">
												<a href="#">Lactancia y Alimentación</a>
											</h2>
											<ul class="nav-categs-detail__categ-list">
												<li><a href="#">Biberones y Accesorios</a></li>
												<li><a href="#">Sillas para comer y Periqueras</a></li>
											</ul>
										</article>
										<article class="nav-categs-detail__categ">
											<h2 class="nav-categs-detail__title">
												<a href="#">Higíene y Cuidado del Bebé</a>
											</h2>
											<ul class="nav-categs-detail__categ-list">
						...
						<a href="Categorias" class="nav-menu-categories-link" tabindex="6">Categorías</a>
					</li>
					<li class="nav-menu-item">
						<a href="#" class="nav-menu-item-link" rel="nofollow" tabindex="6">Ofertas</a>
					</li>
					<li class="nav-menu-item">
						<a href="#" class="nav-menu-item-link" rel="nofollow" tabindex="6">Supermercado</a>
					</li>
					<li class="nav-menu-item">
						<a href="#" class="nav-menu-item-link" rel="nofollow" tabindex="6">Historial</a>
					</li>
					<li class="nav-menu-item">
						<a href="#" class="nav-menu-item-link" rel="nofollow" tabindex="6">Tiendas oficiales</a>
					</li>
					<li class="nav-menu-item">
						<a href="publicar" class="nav-menu-item-link" rel="nofollow" tabindex="6">Vender</a></li><li class="nav-menu-item">
						<a href="#" class="nav-menu-item-link" rel="nofollow" tabindex="7">Ayuda</a>
					</li>
				</ul>
			</div>
			<a href="carrito" title="Carrito" class="nav-cart nav-cart-empty" id="nav-cart" tabindex="9">
		...
		<div class="nav-footer-user-info nav-bounds">
			<div class="nav-footer-info-wrapper">
				<div class="nav-footer-primaryinfo">
					<small class="nav-footer-copyright">Copyright ©&nbsp;1999-2021 DeRemate.com de México S. de R.L. de C.V.</small>
