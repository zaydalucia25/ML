						...
						<div class="vip-actions-wrapper  vip-actions-wrapper--cart-item">
							<div class="vip-actions item-actions u-clearfix">
								<div class="vip-action-primary">
									...
									<input type="submit" data-js="vip-action-cart" title="Agregar al carrito <?=$producto->nombre?>" value="Agregar al carrito" class="ui-button ui-button--secondary without-quantity" tabindex="4" formaction="Carrito">
								</div>
							</div>
						</div>
						<!---->
